  ...
  context "authorized" do
    ...
    describe "POST 'review'" do
      it "reviews a regular doc" do
        ...
        post 'review', :document_id => @sc.evidences[0].id, :value => 1
        response.should be_success
        assert_template :partial => '_document'
        @sc.evidences.reload
        @sc.evidences[0].reviewed.should be_true
        @sc.evidences[0].good.should be_true

        post 'review', :document_id => @sc.evidences[0].id, :value => 'maybe'
        response.should be_success
        assert_template :partial => '_document'
        @sc.evidences.reload
        @sc.evidences[0].reviewed.should be_false
        @sc.evidences[0].good.should be_false
      end
    end
