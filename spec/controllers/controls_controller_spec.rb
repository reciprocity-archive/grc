...
describe ControlsController do
  ...
  context "authorized" do
    before :each do
      login({}, { :role => 'admin' })
      create_base_objects
      @ctl2 = Control.create(:title => 'Control 2', :slug => 'CTL2', :description => 'x', :is_key => true, :fraud_related => false, :program => @creg)
      @ctl3 = Control.create(:title => 'Control 3', :slug => 'CTL2-CTL3', :description => 'x', :is_key => true, :fraud_related => false, :parent => @ctl2, :program => @creg)
