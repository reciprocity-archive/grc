...
class Control < ActiveRecord::Base
  ...
  attr_accessible :title, :slug, :description, :program, :technical, :assertion, :effective_at, :is_key, :fraud_related, :frequency, :frequency_type, :business_area_id, :section_ids
