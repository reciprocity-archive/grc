module ApplicationHelper
  ...
  def admin_project_modules
    %w(accounts biz_processes business_areas control_objectives controls documents document_descriptors regulations people).map { |id| ProjectModule.new(id.humanize, url_for({:controller => "/admin/" + id, :only_path => true})) }
  end
