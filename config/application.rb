...
CMS_CONFIG["SECTION_IMPORT_TEMPLATE"] = ENV["SECTION_IMPORT_TEMPLATE"] if ENV["SECTION_IMPORT_TEMPLATE"]
CMS_CONFIG["CONTROL_IMPORT_TEMPLATE"] = ENV["CONTROL_IMPORT_TEMPLATE"] if ENV["CONTROL_IMPORT_TEMPLATE"]
